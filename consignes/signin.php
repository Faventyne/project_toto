...
EXERCICE++
------------------------
- si ce n'est pas déjà le cas, encoder le mot de passe lors du signup avec password_hash() et vérifier le mot de passe (dans le signin) avec password_verify()
- si il y a un user connecté, alors cacher les liens "Signin" & "Signup" de la navbar
- dans la navbar, si il y a un user connecté, ajouter un lien de déconnexion vers public/disconnect.php (qui va supprimer toutes les données en session)
